...
//modified when we discover the address of the label or variable that it uses.
    ...
    fp = fopen("C:\\Users\\serka\\CLionProjects\\birdAssembler\\input.txt","rw");
...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"jmp")==0||strcmp(token,"call")==0||strcmp(token,"jz")==0)  //-------------- JUMP and CALL -----------------------------
                {
                ...
                else if (strcmp(token,"add")==0) //----------------- ADD -------------------------------
                {
                    ...
                    program[counter]=0x7000+((chch)|0x0000);
                    counter++;
                }
                else if (strcmp(token,"sub")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7000+((chch)|0x0200);
                    counter++;
                    //to be added
                }
                else if (strcmp(token,"and")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7000+((chch)|0x0400);
                    counter++;
                    //to be added
                }
                else if (strcmp(token,"or")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7000+((chch)|0x0600);
                    counter++; //to be added
                }
                else if (strcmp(token,"xor")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7000+((chch)|0x0800);
                    counter++;
                    //to be added
                }
                ...
                else if (strcmp(token,"mov")==0)
                {
                    ...
                    op2 = strtok(NULL,"\n\t\r ");
                    ch = (op1[0]-48)| ((op2[0]-48)<<3);
                    program[counter]=0x7e00+((ch)|0x0040);
                    counter++;
                    //to be added
                }
                else if (strcmp(token,"inc")==0)
                {
                    ...
                    program[counter]=0x7e00+((ch)|0x0080);
                    counter++;
                }
                else if (strcmp(token,"dec")==0)
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    ch = (op1[0]-48)| ((op1[0]-48)<<3);
                    program[counter]=0x7e00+((ch)|0x00c0);
                    counter++;                  //to be added
                }
...
//display the resulting tables
        ...
        printf("\n");
        fclose(fp);
        fp = fopen("C:\\Users\\serka\\CLionProjects\\birdAssembler\\RAM","w");
        fprintf(fp,"v2.0 raw\n");
